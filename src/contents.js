    ...
    "경력 요약": [
      {
        date: ["2021.07.01", "현재"],
        title: "hops (홉스)",
        contents: ["포지션: 공동창업자 / FE 프로그래머", "주: Front-end 개발"],
      },
      {
        date: ["2018.04.23", "2021.06.03"],
        title: "Spoqa (스포카)",
        contents: ["포지션: FE 프로그래머 ", "주: Front-end 개발", "서브: Swift, Android 개발"],
      },
      {
        date: ["2016.01.25", "2018.01.25"],
        title: "ONE MOMENT (원모먼트)",
        contents: ["포지션: FE 프로그래머 ", "주: Front-end 개발", "서브: Swift, Django 개발"],
      },
      {
        date: ["2015.01.02", "2016.01.06"],
        title: "ATEAM VENTURES (에이팀벤쳐스)",
        contents: ["포지션: 프로그래머 ", "주: Front-end 개발", "서브: Django, Flask 개발"],
      },
    ],
  },
  detailContents: {
    "hops (홉스)": {
      date: "2021.07.01 - 현재",
      info: "개발자를 위한 백오피스 빌더 솔루션을 제공하는 스타트업.",
      service: [
        `Web<br /> 
